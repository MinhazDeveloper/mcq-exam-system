...
const exams = ref([
  { id: 1, title: 'React.js Fundamentals', category: 'Frontend', duration: '45 mins', questions: 25, attempts: 1240, status: 'Published', last_modified: '2023-10-15' },
  { id: 2, title: 'Laravel API Development', category: 'Backend', duration: '60 mins', questions: 30, attempts: 850, status: 'Published', last_modified: '2023-10-20' },
  { id: 3, title: 'Vue.js Component Design', category: 'Frontend', duration: '40 mins', questions: 20, attempts: 0, status: 'Draft', last_modified: '2023-11-02' },
]);

const statusClass = (status) => {
  if (status === 'Published') return 'px-3 py-1 bg-green-100 text-green-600 rounded-full text-xs font-medium';
  if (status === 'Draft') return 'px-3 py-1 bg-gray-100 text-gray-600 rounded-full text-xs font-medium';
  return '';
};
</script> -->
